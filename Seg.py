...
dataset = SegmentationDataset(image_dir='E:\\Dive_to_DL\\data',
                              mask_dir='E:\\Dive_to_DL\\mask',
...
for epoch in range(num_epochs):
    ...
    with tqdm(total=len(dataloader), desc=f'Epoch {epoch+1}/{num_epochs}') as pbar:
        ...
        print(f"Epoch {epoch+1}/{num_epochs}, Loss: {running_loss/len(dataloader)}, Time: {epoch_time:.2f}s")
